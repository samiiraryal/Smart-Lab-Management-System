...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.oibJEp9'] ?? self::get_ServiceLocator_OibJEp9Service($container)), ($container->privates['.service_locator.ubTFIF.'] ?? $container->load('get_ServiceLocator_UbTFIF_Service')), ['api_login' => [($container->privates['App\\Security\\TeacherAuthenticator'] ?? $container->load('getTeacherAuthenticatorService'))], 'main' => []], false);
