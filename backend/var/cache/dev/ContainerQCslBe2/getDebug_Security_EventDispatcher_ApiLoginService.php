...
class getDebug_Security_EventDispatcher_ApiLoginService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [#[\Closure(name: 'security.logout.listener.default.api_login', class: 'Symfony\\Component\\Security\\Http\\EventListener\\DefaultLogoutListener')] fn () => ($container->privates['security.logout.listener.default.api_login'] ?? $container->load('getSecurity_Logout_Listener_Default_ApiLoginService')), 'onLogout'], 64);
